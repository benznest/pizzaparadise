  ...
  <tr>
    <th height="57" bgcolor="#FFFFFF" scope="col"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <th width="97" bgcolor="#00A2E8" scope="col"><a href="pizza.php"><img src="image/menu_pizza_2.png" alt="" width="97" height="38" hspace="0" vspace="0" border="0"></a></th>
    ...
    <td height="158" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		if ($db_found) {
			...
			$result= mysql_query("select * from food where (id_cate=1) ORDER BY id_food DESC"); // id_cate =1 is pizza


       echo"<table width='200' border='0' align='left'>
  <tr>
    <th scope='col'><img src='image/pic_pizza.png' width='251' height='65'></th>
  </tr>
</table>";
