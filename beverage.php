  ...
  <tr>
    <th height="57" bgcolor="#FFFFFF" scope="col"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <th width="170" bgcolor="#00A2E8" scope="col"><a href="beverage.php"><img src="image/menu_beverage_2.png" alt="" width="170" height="38" hspace="0" vspace="0" border="0"></a></th>
    ...
    <td height="158" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		if ($db_found) {
			...
			$result= mysql_query("select * from food where (id_cate=4) ORDER BY id_food DESC"); // id_cate =4 beverage
