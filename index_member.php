...
<table width="79%" height="338" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="57" bgcolor="#00A2E8"><?php 
        ...
        <img src='image/menu_all_2.png' width='89' height='38' border='0'></img></a></th>
    ...
    <td height="95" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <th width="74%" rowspan="2" scope="col"><?php 
			...
			$result= mysql_query("select * from food where (id_cate=6)"); // id_cate =1 is pizza
    ...
    <th scope='col'><img src='image/pic_set.png'></th>
        ...
        while($row=mysql_fetch_array($result)){
			if($fact<1){
				...
				echo"		<tr><td><font color='red' size='2'> $row[4]</font></td></tr>";
