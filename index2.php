  ...
  <tr>
    <th height="57" bgcolor="#FFFFFF" scope="col"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <th width="97" bgcolor="#00A2E8" scope="col"><a href="index2.php"><img src="image/menu_all_2.png" width="89" height="38" border="0"></a></th>
    ...
    <td height="158" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		if ($db_found) {
			...
			$result= mysql_query("select * from food where (id_cate=6)"); // id_cate =6 set

echo"<table width='200' border='0' align='left'>
  <tr>
    <th scope='col'><img src='image/pic_set.png'></th>
  </tr>
</table>";
        ...
        while($row=mysql_fetch_array($result)){
			if($fact<1){
				...
				echo"		<tr><td class='leftx'><font color='red' size='2'>$row[4]</font></td></tr>";
