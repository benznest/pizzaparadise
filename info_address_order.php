         ...
         echo" <form action='add_order.php?key1=$id_user&key2=".$pay_total."' method='POST'>";
		  ?>
            <table width="413" align="center">
              ...
              <TR>
                <TD><font color="red">Name Building</font></TD>
                <TD><input type=text name='name_build' id="name_build" ></TD>
              </TR>
              <TR>
              ...
              <TR>
                <TD width="167"><p><strong><font color="red">Post code</font></strong></p></TD>
                <TD width="231"><input type=text name='postcode' id="postcode" ></TD>
                </TR>
              <TR>
