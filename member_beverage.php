...
<table width="79%" height="338" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="57" bgcolor="#FFFFFF"><?php 
		...
		<img src='image/menu_beverage_2.png' alt='' width='170' height='38' hspace='0' vspace='0' border='0'></a></th>
    ...
    <td height="95" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <th width="77%" rowspan="2" scope="col"><?php 
			...
			$result= mysql_query("select * from food where (id_cate=4)"); // id_cate =4 is salad
			
echo"<table width='200' border='0' align='left'>
  <tr>
    <th scope='col'><img src='image/pic_beverage.png'></th>
  </tr>
</table>";
