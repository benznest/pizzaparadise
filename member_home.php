...
<table width="79%" height="338" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="57" bgcolor="#00A2E8"><?php 
		//Menu for Member
        echo"<table border='0' bgcolor='#00A2E8' width='100%'><th width='51' bgcolor='#00A2E8' scope='col'><a href='member_home.php?key1=$id_user'><img src='image/menu_home_2.png' width='102' 
