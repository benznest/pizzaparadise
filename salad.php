  ...
  <tr>
    <th height="57" bgcolor="#FFFFFF" scope="col"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <th width="120" bgcolor="#00A2E8" scope="col"><a href="salad.php"><img src="image/menu_salad_2.png" alt="" width="120" height="38" hspace="0" vspace="0" border="0"></a></th>
    ...
    <td height="158" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		if ($db_found) {
			...
			$result= mysql_query("select * from food where (id_cate=3) ORDER BY id_food DESC"); // id_cate =3 salad
