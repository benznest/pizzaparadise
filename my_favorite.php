...
<table width="80%" height="344" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <th width="890" height="148" bgcolor="#FFFFFF" scope="col"><img src="image/logo1.png" width="804" height="146"></th>
  </tr>
  <tr>
    <th height="57" bgcolor="#00A2E8" scope="col">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <?php 
        echo"<th width='51' bgcolor='#00A2E8' scope='col'><a href='index_member.php?key1=$id_user'>
        <img src='image/menu_home_1.png' alt='' width='102' height='38' hspace='0' vspace='5' border='0' align='left'></a></th>
        
		<th width='97' bgcolor='#00A2E8' scope='col'><a href='index_member.php?key1=$id_user'>
	
        <img src='image/menu_all_2.png' width='89' height='38' border='0' align='left'></a></th>
		
        <th width='97' bgcolor='#00A2E8' scope='col'><a href='member_pizza.php?key1=$id_user'>
		
        <img src='image/menu_pizza_1.png' alt='' width='97' height='38' hspace='0' vspace='0' border='0'  align='left'></a></th>
		
        <th width='240' bgcolor='#00A2E8' scope='col'><a href='member_friedchicken.php?key1=$id_user'><img src='image/menu_friedchicken_1.png' alt='' width='228' height='38' hspace='0' vspace='0' border='0'  align='left'></a></th>
        <th width='120' bgcolor='#00A2E8' scope='col'><a href='member_salad.php?key1=$id_user'><img src='image/menu_salad_1.png' alt='' width='120' height='38' hspace='0' vspace='0' border='0'  align='left'></a></th>
  ...
  <tr>
    <td height="82" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <th width="74%" rowspan="2" bgcolor="#FFFFFF" scope="col">
          <p></p>
          
            <?php 
		   
			$result= mysql_query("SELECT V.id_food,F.name_food,F.detail_food,F.price
								  FROM favorite V,food F
								  WHERE(V.id_member = $id_user and V.id_food = F.id_food)");
			
			$num_rows = mysql_num_rows($result);
			echo"<table border='0'>";
			   echo"<tr><th><img src='image/pic_favorite.png' width='251' height='65' align='left'></th></tr>";
		if($num_rows>0){
			$i=0;
       	 while($row=mysql_fetch_array($result)){
			 	$i++;
				echo" <tr>";
				echo"<th><img src='image/food/$row[0].jpg' size='40'></img></th>";
            	echo"<th width='400'> ";
				echo"		<table  width='100%'>";
				echo"		<tr><td><font color='red'>$row[1]</font></td></tr>";
				echo"		<tr><td><font color='red' size='2'>$row[2].-</font></td></tr>";
				...
				echo"		</table>";
				echo"</th>
				<th><a href='remove_favorite.php?key1=".$row[0]."&key2=".$id_user."'><img src='image/bt_remove.png' border='0'></img></a>
				  <br><a href='info_basket_page.php?key1=".$id_user."&key2=".$row[0]."'><img src='image/bt_add_basket.png' border=0></img></a>
				</font></th>
				</tr>";
            	//echo"<th width='100'></th>";
        	}
			echo"<tr><th><font color='red'>list favorite All $i items.</font></th></tr>";
		}
		else{
			echo"<tr><th><font color='red' size='5'>You have not favorite item.</font></th></tr>";
		}
       echo "</table>";
